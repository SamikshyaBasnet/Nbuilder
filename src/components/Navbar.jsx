    ...
    <>
      ...
      <nav className={`mobile-drawer${menuOpen ? ' open' : ''}`} aria-label="Mobile navigation">
        ...
        <div className="mobile-contact">
          <p>Call us anytime</p>
          <a href="tel:9843369116" className="mobile-phone">📞 98433 69116</a>
          <a href="tel:9812898151" className="mobile-phone">📞 98128 98151</a>
          <a href="#contact" className="btn-primary" style={{ marginTop: 20, justifyContent: 'center' }}
